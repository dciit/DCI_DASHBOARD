import {  ApsProductionPlanProps, GasTightProps } from '@/interface/aps.interface';
import { API_APS_PRODUCTION_PLAN, API_GET_GASTIGHT  } from '@/service/aps.service';
    ...
    return (
        <div>
            <div className='grid grid-cols-1 gap-3'>
                ...
                <div className='grid gap-6 grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-5'>
                    <div className='col-span-1 sm:col-span-1 md:col-span-1 lg:col-span-2 shadow-lg'>
                        <table className='w-full '>
                            <thead className='text-[12px] sm:text-sm'>
                                <tr>
                                    <td className='border text-center bg-[#5c5fc8] text-white py-2' colSpan={6}>Sequence Main Assy</td>
                                </tr>
                                <tr>
                    ...
                    <div className='col-span-1 sm:col-span-1 md:col-span-1 lg:col-span-3 shadow-lg'>
                        <table className='w-full text-[14px]'>
                            <thead className='bg-[#5c5fc8] text-white'>
                                <tr>
                                    <td className='border w-[75%] pl-6 py-3' colSpan={23}>ข้อมูลเมื่อ : <span className='font-semibold uppercase '>{dtNow.format('DD MMM YYYY')}</span></td>
                                </tr>
                                < tr>
